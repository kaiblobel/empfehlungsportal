...
status: live (Beta) - v1.164 entfernt das Aufblitzen des Standard-Portraits beim Laden (Kundenseiten starten ohne Bildquelle, gemerktes Branding pro Link, Initialen-Kreis statt fremdem Foto); v1.163 zeigt auf den Themenseiten (Empfaenger-Seite, Finanzierungskompass) und in der Themen-Vorschau den richtigen Berater statt des Kai-Defaults (Aufloesung ueber ?berater=slug bzw. eingeloggten Berater); v1.162 ersetzt den frei berechneten Momentum-Score durch vier echte Netzwerk-Kennzahlen direkt unter dem Einstieg und entfernt den doppelten Kennzahlenblock; v1.161 tote Erfolgsgeschichten-Funktion aus Navigation, Verwaltung und Empfänger-Datenweg entfernt (DB-Tabelle bleibt erhalten); v1.160 Belohnungs-Einstieg gestrafft (Win-Win-Karten und doppelte Belohnungs-Pille entfernt); v1.159 Versionsanzeige verlaesslich (config.js network-first; CACHE_VERSION bei JEDER Freigabe hochzaehlen); v1.158 Praesentationsseite auf 13 Abschnitte gestrafft; v1.157 Praesentationsseite: Tastatursteuerung beim Vortragen, FAQ und Bewertungen entfernt; v1.156 Folien-Modus entfernt (Kai traegt scrollend vor), Einrasten beim Scrollen; v1.154 Praesentationsseite startet mit dem Hero, Zufriedenheitsfrage folgt (Portrait dort entfallen, Zitat bleibt); v1.153 Belohnungen als senkrechte Meilensteinreise (15 echte Stufen in der DB, 5 Bild-Meilensteine, nichts mehr im Browser erfunden); v1.152 Themen-Editor auf die 6 wirksamen Felder eingedampft (Bild/Vorteile/Subtext wurden von keiner Seite mehr gelesen); v1.151 Startseite heisst ueberall "Ueberblick" (Marke bleibt Empfehlungs-HUB); v1.150 klare Menuenamen (Bonusprogramm, Auszahlungen, Team) durchgaengig bis Seitentitel; v1.149 Menue zweigeteilt (Tagesgeschaeft / Verwaltung), Berater zu Team, Admin-Abschnitte der Einstellungen nur fuer Admins; v1.148 Navigation heißt durchgehend "Promoter" (Champions nur noch fuer die Top 3 im Hub); v1.147 Aktivitäts-Feed rechts bricht sauber um statt abgeschnitten zu werden; v1.146 kein Bild-Flackern beim Laden; v1.145 Promoter-Liste sortierbar (Datum/Kunden/Empfehlungen/Name); v1.143 Einladungs-Link für Promoter direkt aus dem Dashboard verschickbar (nach Anlegen, Rechtsklick, Detailseite; WhatsApp/Mail/Kopieren), Promoter-Liste nach Datum; v1.142 Belohnungen/Themen entdoppelt (Klon-Zeilen eines zweiten Beraters werden gefiltert), Roadmap-Bonusstufen + Belohnungs-Filter korrigiert, Promoter-Einladung führt wieder ins Empfehlungs-Formular; Power Automate durch fehlende Premium-Lizenz blockiert
