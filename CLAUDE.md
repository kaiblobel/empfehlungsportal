...
status: live v1.193 mit privatem Potenzialbuch (eigene RLS-geschuetzte Tabelle je Berater, keine Verbindung zu Empfehlungen, Promotern, Praemien, Benachrichtigungen oder Kennzahlen, bewusste manuelle Cockpit-Uebergabe), Sicherheits-Nachzug (Cockpit-Bruecke nutzt gehashtes wechselbares Geheimnis statt Klartext, stufe_notifications ohne weite anon-Schreibrechte, interne SQL/Doku/Tests per .vercelignore nicht mehr oeffentlich abrufbar), mobile-first Portal und gefuehrter mobiler Praesentation. Phase 167 aktiv. OFFEN: geleakte-Passwoerter-Schutz in Supabase Auth ist noch AUS (Dashboard-Schalter, Kai)
