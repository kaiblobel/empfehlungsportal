...
prepared: v1.195 Potenzialbuch-Cockpit-Verbindung lokal auf codex/potenzialbuch-cockpit-verbindung vorbereitet; bewusste Verbindung, vorhandene eigene Akte nur bei exaktem Telefon- oder E-Mail-Treffer, sonst neuer Interessent; feste Beraterzuordnung serverseitig und fail-closed; nur aktives und eingerichtetes Cockpit-Konto darf verbinden, sonst sichtbare ausgegraute Vorschau mit Demnaechst und serverseitige Sperre; Cockpit fuehrt Interessent/Kunde/Altkunde; Umgebungsziel folgt sicher der konfigurierten API; 58 Portaltests gruen; Cockpit-Migration nicht angewendet, nichts veroeffentlicht; Live bleibt v1.194
status: live v1.194 mit privatem Potenzialbuch und Kontaktstaerke (Mehrfach-Kreise, automatische Einstufung kalt bis sehr heiss, ruhige Symbole, Kreis- und Staerkefilter, manuelle Korrektur). Eigene RLS-geschuetzte Tabelle je Berater, keine Verbindung zu Empfehlungen, Promotern, Praemien, Benachrichtigungen oder Kennzahlen, bewusste manuelle Cockpit-Uebergabe. Phase 168 und Migration phase168_potenzialbuch_kontaktstaerke aktiv. 18/18 Tests und Vercel-Produktion READY. OFFEN: echter eingeloggter Sicht- und Praxistest.
