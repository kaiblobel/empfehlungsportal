...
status: live mit sichtbarer Marke der Regionaldirektion (Emblem auf der Anmeldeseite, Namenszug in Schreibschrift aus mitgelieferter Schriftdatei in der Seitenleiste), neu erzählter Präsentation (elf Abschnitte, Themenauswahl als Weiche im Gespräch, Lebensachse statt Themenraster, Marktübersicht als großes Rad mit antippbaren Feldern), KIDZ-Elternseite als Zug mit acht Bausteinen, KIDZ-Anmeldeseite (/kidz/elternabend) im Look der Konzeptseite mit Heuwagen-Foto, Begrüßung je Herkunft, ohne Verkaufswörter und mit einem Berater nur über dessen persönlichen Anmeldelink, ausführlicher Überblicksseite hinter der Kachel "Ganz allgemein" (noch nicht im Menü verlinkt), eigenen Bildern und eigener Anschrift je Berater, sicherem Gerätewechsel per Einmal-Link und einem Admin-Wartungsschalter, der den Partnerbereich schließt ohne die Kundenseiten anzufassen; die Themenseite spielt wieder den ursprünglichen Erstgesprächsfilm (1:37), die 25-Sekunden-Probefassung ist zurückgenommen; der Promoterfilm in der Präsentation läuft weiter in der 60-Sekunden-Fassung mit Beratungsszene ab 0:39 und Schlusskarte ab 0:53; der Anwendungswechsler fuer den Partnerbereich holt seine Liste aus der zentralen Freigabematrix in KAI. und wartet auf die Einrichtung der Verbindung Lokal vorbereitet am 15.09.2026 auf konrad/portal-betriebszentrale: Portaladapter zur bestehenden Betriebszentrale; Eigentümer-Gate für Laufzeitablage und Hosting offen, nicht veröffentlicht.
release: Das Promoterprofil trägt die Hausschrift DVAG-Type (gesperrt in der Datenbank, nur für angemeldete Berater, weil das Repo öffentlich ist), ruhige Überschriften im Gewicht 400 und gezeichnete Symbole; die Promoter-Seite und ihre Vorschau folgen als Kundenseite der ruhigen Linie von Kundenseite und Service-App; Schriften kommen nicht mehr von Google
