...
status: LIVE mit originaler KIDZ-Konzept-Marke auf Sommerfest, Gewinnspiel und Elternabend sowie klar getrennten CI-Farbfamilien und strategischer Baufinanzierungsansprache; ZUR VERÖFFENTLICHUNG FREIGEGEBEN: vollständige anbieterfreie KIDZ-Konzeptseite mit großer Bilderstrecke
release: Die öffentlichen KIDZ-Wege zeigen die originale runde Marke mit Lok; die neue Konzeptseite ergänzt einen eigenständigen Elternweg, Navigation, Anmeldung und persönliche Zuordnung der bestehenden Seiten bleiben unverändert
