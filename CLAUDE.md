...
status: live v1.191 mit mobile-first Portal (Bottom-Navigation Ueberblick/Empfehlungen/Promoter/Mehr bis 767px, gestapelte Hot-Lead-Karten, keine abgeschnittenen Pillen und Beschriftungen) und gefuehrter mobiler Praesentation (feste Leiste Zurueck/Fortschritt/Weiter bis 767px, jeder Abschnitt als volle Seite, Leiste weicht beim freien Scrollen, dynamische Abschnittszaehlung fuer alle drei Laengen), QR-Selbstanmeldung, sofortigem Hinweis bei neuen Promotern, Praesentation in drei Laengen (60 Sek. / Kurz / Ausfuehrlich), Formel-Video und serverseitig erzwungener Mandantentrennung bei Promoter-Empfehlungen; beide Erklaervideos KI-gekennzeichnet (sichtbar + C2PA), Phase 165 aktiv
