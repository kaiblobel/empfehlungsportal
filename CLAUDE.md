...
status: live v1.192 mit Sicherheits-Nachzug (Cockpit-Bruecke nutzt gehashtes wechselbares Geheimnis statt Klartext, stufe_notifications ohne weite anon-Schreibrechte, interne SQL/Doku/Tests per .vercelignore nicht mehr oeffentlich abrufbar), mobile-first Portal (Bottom-Navigation bis 767px, gestapelte Hot-Lead-Karten) und gefuehrter mobiler Praesentation (feste Leiste bis 767px, volle Seiten, Leiste weicht beim Scrollen, dynamische Abschnittszaehlung fuer alle drei Laengen), QR-Selbstanmeldung, sofortigem Hinweis bei neuen Promotern, Praesentation in drei Laengen (60 Sek. / Kurz / Ausfuehrlich), Formel-Video und serverseitig erzwungener Mandantentrennung bei Promoter-Empfehlungen; beide Erklaervideos KI-gekennzeichnet (sichtbar + C2PA), Phase 166 aktiv. VORBEREITET, NICHT LIVE: privates Potenzialbuch auf codex/potenzialbuch-v1, lokale Migration schema-phase167.sql nicht angewendet, unabhaengige Sichtpruefung und Freigabe offen. OFFEN: geleakte-Passwoerter-Schutz in Supabase Auth ist noch AUS (Dashboard-Schalter, Kai)
