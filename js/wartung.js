...
(function () {
  ...
  function stile() {
    ...
    s.textContent = [
      ...
      'color:#13191D;border-radius:9px;padding:10px 22px;font-size:14px;font-weight:400;',
      ...
      '#' + SCHIRM_ID + ' .w-fuss a{color:#8F7809;font-weight:400;text-decoration:none}',
      ...
      '#' + SCHIRM_ID + ' .w-absender-text b{display:block;font-weight:400;color:#13191D;font-size:13px}',
      ...
      "font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;font-size:13px;font-weight:400}",
      '#' + BAND_ID + ' a{color:#fff;text-decoration:underline;margin-left:8px;font-weight:400}',
      ...
      'justify-content:center;gap:14px;font-size:13px;font-weight:400;flex-wrap:wrap}',
      '#' + SCHIRM_ID + ' .w-vorschauband button{background:rgba(255,255,255,.18);border:0;',
      'color:#fff;font-family:inherit;font-size:12px;font-weight:400;padding:5px 13px;',
