...
comment on column public.kidz_gewinnspiel_teilnahmen.ticket_number is
  'Nummer des vor Ort ausgegebenen Doppelloses fuer die zusaetzliche Hauptgewinnziehung. Ein Los pro volljaehriger Person und Veranstaltung.';
comment on column public.kidz_gewinnspiel_teilnahmen.ticket_issued_at is
  'Zeitpunkt der persoenlichen Losausgabe fuer die zusaetzliche Hauptgewinnziehung.';
